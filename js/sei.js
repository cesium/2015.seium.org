...
.controller('organizationCtrl',['$scope','$window',function($scope,$window){
    var staffs= [
        // slide 01#
            ...
            {pic: 'img/staff/mpinto.jpg', name:'Miguel Pinto', position: 'Vice Presidente', enterprise: 'Minho', facebook:'', twitter: 'https://twitter.com/mcpinto98', github: 'https://github.com/miguelpinto98',linkedin:'pt.linkedin.com/in/miguelpinto98'},
            ...
            {pic: 'img/staff/pmaia.jpg', name:'Pedro Maia', position: 'Tesoureiro', enterprise: 'Minho', facebook:'', twitter: '', github: 'https://github.com/PedroMaia',linkedin:'pt.linkedin.com/in/maiarib'},
            {pic: 'img/staff/pbarros.jpg', name:'Patricia Barros', position: 'Secretária', enterprise: 'Minho', facebook:'', twitter: '', github: 'https://github.com/7patricia',linkedin:'pt.linkedin.com/in/7patricia'},
            {pic: 'img/staff/fmendes.jpg', name:'Fernando Mendes', position: 'Director do Centro de Apoio ao Open Source', enterprise: 'Minho', facebook:'', twitter: 'https://twitter.com/fribmendes', github: 'https://github.com/frmendes',linkedin:'pt.linkedin.com/in/fribmendes'},
            ...
            {pic: 'img/staff/sei.jpg', name:'Tiago Cunha', position: 'Director do Departamento Recreativo', enterprise: 'Minho', facebook:'https://www.facebook.com/Apocalipse.113', twitter: '', github: '',linkedin:''},
            {pic: 'img/staff/sei.jpg', name:'Pedro Faria', position: 'Vice Director do Departamento Recreativo', enterprise: 'Minho', facebook:'https://www.facebook.com/NoventaESeis', twitter: '', github: '',linkedin:''},
            {pic: 'img/staff/sei.jpg', name:'Gil Gonçalves', position: 'Vice Director do Departamento Recreativo', enterprise: 'Minho', facebook:'https://www.facebook.com/gil.goncalves.161', twitter: '', github: '',linkedin:''},
            ...
            {pic: 'img/staff/mmedeiros.jpg', name:'Mariana Medeiros', position: 'Vice Directora do Departamento de Comunicação', enterprise: 'Minho', facebook:'', twitter: 'https://twitter.com/MariMedeiros63', github: 'https://github.com/Mariana63',linkedin:'pt.linkedin.com/in/mariana63medeiros'},
            ...
            {pic: 'img/staff/sei.jpg', name:'Sandra Ferreira', position: 'Vogal', enterprise: 'Minho', facebook:'https://www.facebook.com/sandra.ferreira.96742', twitter: '', github: '',linkedin:''},
            ...
            {pic: 'img/staff/dcarvalho.jpg', name:'Daniel Carvalho', position: 'Assembleia Geral', enterprise: 'Minho', facebook:'', twitter: 'https://twitter.com/dapcarvalho/', github: 'https://github.com/Insatisfeito',linkedin:'pt.linkedin.com/in/dapcarvalho/'},
            {pic: 'img/staff/sei.jpg', name:'Ricardo Branco', position: 'Assembleia Geral', enterprise: 'Minho', facebook:'https://www.facebook.com/ricardobranco28', twitter: '', github: '',linkedin:''},
            {pic: 'img/staff/sei.jpg', name:'André Pimenta', position: 'Conselho Fiscal', enterprise: 'Minho', facebook:'https://www.facebook.com/pimenta53', twitter: '', github: '',linkedin:''},
            ...
            {pic: 'img/staff/pcardoso.jpg', name:'Paulo Cardoso', position: 'Membro', enterprise: 'Minho', facebook:'', twitter: 'https://twitter.com/HeadlessHeader', github: 'https://github.com/pcardosolei',linkedin:'pt.linkedin.com/in/pcardosolei/'},
            ...
            {pic: 'img/staff/dduarte.jpg', name:'Duarte Duarte', position: 'Membro', enterprise: 'Minho', facebook:'', twitter: 'https://twitter.com/duknust', github: 'https://github.com/duknust',linkedin:'pt.linkedin.com/in/duarteduarte'},
            {pic: 'img/staff/bferreira.jpg', name:'Bruno Ferreira', position: 'Membro', enterprise: 'Minho', facebook:'https://www.facebook.com/chalkos', twitter: 'https://twitter.com/chalkos', github: 'https://github.com/chalkos',linkedin:'pt.linkedin.com/in/chalkos'},
            ...
            {pic: 'img/staff/sei.jpg', name:'Duarte Araújo', position: 'Membro', enterprise: 'Minho', facebook:'https://www.facebook.com/Duarte.Araujo1', twitter: 'https://twitter.com/PMDAraujo', github: 'https://github.com/PMDA',linkedin:''},
