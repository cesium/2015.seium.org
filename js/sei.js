     ...
     var speakers =
        ...
        [
            ...
            {pic:'img/speakers/rmachado.jpg', name:'Roberto Machado', position:'CEO' , enterprise:[{name:'Group Buddies',  enterpriseUrl:'https://groupbuddies.com/'}], web:'http://groupbuddies.com/' , twitter:'https://twitter.com/rmdgb', github:'https://github.com/rmdmachado',
                about:'Engenheiro Informático de formação pela Universidade do Minho, tem muita experiência em Gestão e Empreendedorismo. Sempre teve especial interesse na criação de novos projectos. Actualmente é CEO da Group Buddies, uma empresa que desenvolve produtos web e mobile, e onde tem a oportunidade de gerir um grupo fantástico de profissionais todos eles apaixonados pelo mundo da Web.'},
...
.controller('organizationCtrl',['$scope','$window',function($scope,$window){
    var staffs= [
        // slide 01#
            ...
            {pic: 'img/staff/smendes.png', name:'Susana Mendes', position: 'Membro', enterprise: 'Minho', facebook:'', twitter: 'https://twitter.com/Su__Mendes', github: '',linkedin:'https://www.linkedin.com/pub/susana-mendes/43/8b8/906'},
