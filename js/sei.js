...
.controller('organizationCtrl',['$scope','$window',function($scope,$window){
    var staffs= [
        // slide 01#
            ...
            {pic: 'img/staff/mmedeiros.jpg', name:'Mariana Medeiros', position: 'Vice Diretora do Departamento de Comunicação', enterprise: 'Minho', facebook:'', twitter: 'https://twitter.com/MariMedeiros63', github: 'https://github.com/Mariana63',linkedin:'https://pt.linkedin.com/in/mariana63medeiros'},
