...
.controller('speakerCtrl',['$scope','$window','$rootScope',function($scope,$window,$rootScope){
     var speakers =
        ...
        [
            ...
            {pic:'img/speakers/pvieira.jpg', name:'Paulo Vieira', position:'Analista Programador' , enterprise:[{name:'iMobileMagic',  enterpriseUrl:'http://www.imobilemagic.com/'}], web:'http://www.imobilemagic.com/' , twitter:'https://twitter.com/imobilemagic', github:'',
...
.controller('organizationCtrl',['$scope','$window',function($scope,$window){
    var staffs= [
        // slide 01#
            ...
            {pic: 'img/staff/sei.jpg', name:'Daniel Carvalho', position: 'Assembleia Geral', enterprise: 'Minho', facebook:'https://www.facebook.com/dapcarvalho', twitter: 'https://twitter.com/dapcarvalho/', github: 'https://github.com/Insatisfeito'},
